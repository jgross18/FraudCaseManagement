...
class CreateTestTransactionsV51V100 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('test_transactions_v51-v100', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('test_transactions_v51-v100');
    }
}
