...
class CreateTrainTransactionsV201V250 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('train_transactions_v201-v250', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('train_transactions_v201-v250');
    }
}
