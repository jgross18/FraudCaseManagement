...
class CreateTrainTransactionsV151V200 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('train_transactions_v151-v200', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('train_transactions_v151-v200');
    }
}
