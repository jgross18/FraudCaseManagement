...
class CreateTrainTransactionsV251V300 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('train_transactions_v251-v300', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('train_transactions_v251-v300');
    }
}
