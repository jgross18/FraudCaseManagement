...
class CreateTestTransactionsV1V50 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('test_transactions_v1-v50', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('test_transactions_v1-v50');
    }
}
